        ...
        <b-row>
            <b-col>
                ...
                <b-collapse id="collapse-1">
                    <br />
                    <ol>
                        <li>Upload a TSV phenotypic file (<a href="https://neurobagel.org/data_prep/" target="_blank">see our docs for details</a>)</li>
                    ...
                    <b>What next?</b>
                    <p>
                        You can now use the n data dictionary to <a href="https://neurobagel.org/cli/" target="_blank">create a harmonized representation of your subject-level data</a> (optional, uses other neurobagel tools).<br>
