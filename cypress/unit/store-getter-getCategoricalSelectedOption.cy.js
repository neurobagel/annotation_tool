...
describe("getCategoricalSelectedOption", () => {
    ...
    it("Get the value mapped to a raw value exists in a column that exists in the value map", () => {
        ...
        // Act
        const mappedValue = getters.getCategoricalSelectedOption(store.state)("column1", "raw_value1");
    ...
    it("Attempt to get a value mapped to raw value that does not exist in a column that exists in the value map", () => {
        ...
        // Act
        const mappedValue = getters.getCategoricalSelectedOption(store.state)("column1", "raw_value2");
    ...
    it("Attempt to get a value mapped to a raw value in a column that does not exist in the value map", () => {
        ...
        // Act
        const mappedValue = getters.getCategoricalSelectedOption(store.state)("column2", "raw_value1");
