describe("to annotate an assessment ", () => {
    it("sets up some stuff", () => {
        ...
        cy.get('#__BVID__156___BV_tab_button__').click();
        ...
        cy.get('#__BVID__77__BV_tab_controls_').click();
        ...
        cy.get('#__BVID__156').click();
        cy.get('[aria-colindex="5"] > [data-cy="missingValueButton_2"]').click();
        cy.get('#__BVID__195___BV_tab_button__').click();
        ...
        cy.get('#__BVID__225___BV_tab_button__').click();
